"""
Versioned classifier prompt — §9.6 of CLAUDE_STRATEGY_SPEC_v3.

Mirrored to specs/prompts/classifier_v1.md for human review.
Sync verified by test.
"""

CLASSIFIER_PROMPT_V1 = """You are a market regime classifier for a quantitative trading system.
